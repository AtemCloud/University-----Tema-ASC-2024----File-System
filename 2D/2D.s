...
# Surprinsingly it was easier than expected to go from 1D to 2D

# Add -Done
# Delete- Done somehow
# Get - Done
# Defragmentation - not sure
...
# two pointers approach
    ...
    Defrag_non_zero:
        ...
        movl (%esi,%edx,4), %eax
        cmpl LINE_CODE, %eax
        je Defrag_restore_line

        Defrag_non_zero_continue:
        incl write_pointer
